...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sidebarDiscordBot: "Discord Bot",
      notificationRepliesTitle: "Notification Replies",
      notificationRepliesSubtitle: "Customize the character nickname and messages shared by Discord and LINE.",
      sidebarLineNotifications: "LINE Notifications",
      lineNotificationsTitle: "LINE Notifications",
      lineNotificationsSubtitle: "Send a short LINE message when a task finishes or needs your attention. No remote approval is included.",
      lineNotificationsSetupTitle: "LINE Messaging API",
      lineNotificationsTokenLabel: "Channel access token",
      lineNotificationsTokenDesc: "Stored in a separate user-data file and never written to Clawd preferences.",
      lineNotificationsTokenConfiguredDesc: "A token is already stored. Saving replaces it.",
      lineNotificationsTokenPlaceholder: "Paste channel access token",
      lineNotificationsSaveToken: "Save token",
      lineNotificationsTokenRequired: "Paste a channel access token first.",
      lineNotificationsTokenSaveFailed: "Could not save the LINE token.",
      lineNotificationsTokenSaved: "LINE token saved.",
      lineNotificationsUserIdLabel: "Your LINE user ID",
      lineNotificationsUserIdDesc: "Use the 33-character Messaging API user ID beginning with U.",
      lineNotificationsUserIdPlaceholder: "U0123456789abcdef0123456789abcdef",
      lineNotificationsSaveUserId: "Save user ID",
      lineNotificationsTestLabel: "Test notification",
      lineNotificationsTestDesc: "Send one test message. This uses one message from your LINE plan.",
      lineNotificationsSendTest: "Send test",
      lineNotificationsTestFailed: "Could not send the LINE test message.",
      lineNotificationsTestSent: "LINE test message sent.",
      lineNotificationsControlTitle: "Notification controls",
      lineNotificationsEnableLabel: "Send LINE notifications",
      lineNotificationsEnableDesc: "Master switch. Turning this off stops all LINE API calls immediately.",
      lineNotificationsEnableNeedsSetup: "Save a token and valid LINE user ID before enabling.",
      lineNotificationsCompleteLabel: "Task completed",
      lineNotificationsCompleteDesc: "Include the task title, agent, project, and short session ID.",
      lineNotificationsAttentionLabel: "Needs attention",
      lineNotificationsAttentionDesc: "Notify only that you need to return to the computer; no approval details are sent.",
      lineNotificationsSaved: "LINE notification settings saved.",
      discordBotTitle: "Discord Bot Notifications",
      discordBotSubtitle: "Connect a bot and choose the Discord channel that receives task notifications.",
      discordBotSetupTitle: "Discord Bot",
      discordBotTokenLabel: "Bot token",
      discordBotTokenDesc: "Stored in a separate user-data file and never written to Clawd preferences.",
      discordBotTokenConfiguredDesc: "A token is already stored. Saving replaces it.",
      discordBotTokenPlaceholder: "Paste bot token",
      discordBotSaveToken: "Save token",
      discordBotTokenRequired: "Paste a Discord bot token first.",
      discordBotTokenSaveFailed: "Could not save the Discord bot token.",
      discordBotTokenSaved: "Discord bot token saved.",
      discordBotChannelIdLabel: "Notification channel ID",
      discordBotChannelIdDesc: "The bot sends completion messages only to this channel.",
      discordBotChannelIdPlaceholder: "e.g. 123456789012345678",
      discordBotSaveChannelId: "Save channel ID",
      discordBotTestLabel: "Test notification",
      discordBotTestDesc: "Send one safe test message to the configured channel.",
      discordBotSendTest: "Send test",
      discordBotTestFailed: "Could not send the Discord test message.",
      discordBotTestSent: "Discord test message sent.",
      discordBotControlTitle: "Notification controls",
      discordBotEnableLabel: "Send Discord notifications",
      discordBotEnableDesc: "Master switch. Turning this off stops all Discord API calls immediately.",
      discordBotEnableNeedsSetup: "Save a token and valid channel ID before enabling.",
      discordBotCompleteLabel: "Task completed",
      discordBotCompleteDesc: "Uses the same randomized completion replies as LINE and avoids immediate repeats.",
      discordBotSaved: "Discord bot notification settings saved.",
      discordBotRepliesTitle: "Message replies",
      discordBotNicknameLabel: "Character nickname",
      discordBotNicknameDesc: "The name your character uses in notifications.",
      discordBotNicknamePlaceholder: "e.g. Milktea",
      discordBotCompleteRepliesLabel: "Task completed replies",
      discordBotCompleteRepliesDesc: "One reply is chosen at random whenever a task finishes.",
      discordBotReplyLabel: "Reply",
      discordBotDeleteReply: "Delete",
      discordBotAddReply: "+ Add reply",
      discordBotInterruptedReplyLabel: "Task failed or interrupted",
      discordBotInterruptedReplyDesc: "Sent when a task stops before completion.",
      discordBotPermissionReplyLabel: "Permission needed",
      discordBotPermissionReplyDesc: "Sent when you need to return to the computer to approve something.",
      discordBotChoiceReplyLabel: "Waiting for your choice",
      discordBotChoiceReplyDesc: "Sent when the task needs you to choose an option.",
      discordBotInsertValue: "Insert:",
      discordBotVariableOwner: "Mention owner",
      discordBotVariableTask: "Task name",
      discordBotVariableProject: "Project name",
      discordBotVariableAgent: "Agent name",
      discordBotVariableSession: "Session ID",
      discordBotPreviewLabel: "Preview",
      discordBotPreviewTask: "Example task",
      discordBotPreviewResult: "Example result",
      discordBotPreviewProject: "Example project",
      discordBotSaveReplies: "Save replies",
      discordBotResetReplies: "Restore defaults",
      discordBotResetRepliesConfirm: "Restore all nicknames and replies to their defaults?",
      discordBotRepliesLoading: "Loading replies...",
      discordBotRepliesLoadFailed: "Could not load replies. Reopen Settings and try again.",
      discordBotRepliesSaveFailed: "Could not save replies.",
      discordBotRepliesSaved: "Replies saved.",
      discordBotRepliesReset: "Default replies restored.",
      discordBotAtLeastOneReply: "Keep at least one task completed reply.",
      discordBotEmptyReply: "Fill in every reply before saving.",
      ...
      rowSessionHudMaxProjects: "Maximum visible projects",
      rowSessionHudMaxProjectsDesc: "Default 5. Enter 0 to show all projects. Child agents do not count toward this limit.",
      unitProjects: "projects",
      valueAll: "All",
      rowSessionHudProjectFilter: "Visible project",
      rowSessionHudProjectFilterDesc: "Show every project or only the selected project and its child agents.",
      sessionHudProjectAll: "All projects",
    ...
    zh: {
      ...
      sidebarLineNotifications: "LINE 通知",
      sidebarDiscordBot: "Discord Bot",
      notificationRepliesTitle: "通知回复",
      notificationRepliesSubtitle: "修改角色昵称，以及 Discord 与 LINE 共用的完成、失败和等待回复。",
      discordBotTitle: "Discord Bot Notifications",
      discordBotSubtitle: "连接 Bot，并选择接收任务通知的 Discord 频道。",
      discordBotSetupTitle: "Discord Bot",
      discordBotTokenLabel: "Bot token",
      discordBotTokenDesc: "Stored in a separate user-data file and never written to Clawd preferences.",
      discordBotTokenConfiguredDesc: "A token is already stored. Saving replaces it.",
      ...
      discordBotCompleteDesc: "Uses the same randomized completion replies as LINE and avoids immediate repeats.",
      discordBotSaved: "Discord bot notification settings saved.",
      discordBotRepliesTitle: "消息回复",
      discordBotNicknameLabel: "角色昵称",
      discordBotNicknameDesc: "角色在通知中使用的名字。",
      discordBotNicknamePlaceholder: "例如：奶茶",
      discordBotCompleteRepliesLabel: "任务完成回复",
      discordBotCompleteRepliesDesc: "每次任务完成时随机选择一条回复。",
      discordBotReplyLabel: "回复",
      discordBotDeleteReply: "删除",
      discordBotAddReply: "+ 新增回复",
      discordBotInterruptedReplyLabel: "任务失败或中断",
      discordBotInterruptedReplyDesc: "任务未完成便停止时发送。",
      discordBotPermissionReplyLabel: "需要权限",
      discordBotPermissionReplyDesc: "需要你回到电脑确认权限时发送。",
      discordBotChoiceReplyLabel: "等待你的选择",
      discordBotChoiceReplyDesc: "任务需要你选择选项时发送。",
      discordBotInsertValue: "插入内容：",
      discordBotVariableOwner: "通知主人",
      discordBotVariableTask: "任务名称",
      discordBotVariableProject: "项目名称",
      discordBotVariableAgent: "Agent 名称",
      discordBotVariableSession: "识别码",
      discordBotPreviewLabel: "预览",
      discordBotPreviewTask: "示例任务",
      discordBotPreviewResult: "示例结果",
      discordBotPreviewProject: "示例项目",
      discordBotSaveReplies: "保存回复",
      discordBotResetReplies: "恢复默认",
      discordBotResetRepliesConfirm: "确定要把昵称和所有回复恢复为默认内容吗？",
      discordBotRepliesLoading: "正在载入回复……",
      discordBotRepliesLoadFailed: "无法载入回复，请重新打开设置后再试。",
      discordBotRepliesSaveFailed: "无法保存回复。",
      discordBotRepliesSaved: "回复已保存。",
      discordBotRepliesReset: "已恢复默认回复。",
      discordBotAtLeastOneReply: "至少保留一条任务完成回复。",
      discordBotEmptyReply: "请填写所有回复后再保存。",
      lineNotificationsTitle: "LINE 手机通知",
      lineNotificationsSubtitle: "任务完成或需要你处理时发送简短 LINE 消息，不提供手机远程审批。",
      lineNotificationsSetupTitle: "LINE Messaging API",
      lineNotificationsTokenLabel: "Channel access token",
      lineNotificationsTokenDesc: "Token 单独保存在用户数据文件中，不会写入 Clawd 偏好设置。",
      lineNotificationsTokenConfiguredDesc: "已保存 Token；再次保存会将其替换。",
      lineNotificationsTokenPlaceholder: "粘贴 Channel access token",
      lineNotificationsSaveToken: "保存 Token",
      lineNotificationsTokenRequired: "请先粘贴 Channel access token。",
      lineNotificationsTokenSaveFailed: "无法保存 LINE Token。",
      lineNotificationsTokenSaved: "LINE Token 已保存。",
      lineNotificationsUserIdLabel: "你的 LINE user ID",
      lineNotificationsUserIdDesc: "请输入 Messaging API 中以 U 开头的 33 位 user ID。",
      lineNotificationsUserIdPlaceholder: "U0123456789abcdef0123456789abcdef",
      lineNotificationsSaveUserId: "保存 user ID",
      lineNotificationsTestLabel: "测试通知",
      lineNotificationsTestDesc: "发送一条测试消息；会使用 LINE 套餐的一条消息额度。",
      lineNotificationsSendTest: "发送测试",
      lineNotificationsTestFailed: "LINE 测试消息发送失败。",
      lineNotificationsTestSent: "LINE 测试消息已发送。",
      lineNotificationsControlTitle: "通知控制",
      lineNotificationsEnableLabel: "发送 LINE 通知",
      lineNotificationsEnableDesc: "总开关；关闭后立即停止所有 LINE API 调用。",
      lineNotificationsEnableNeedsSetup: "请先保存 Token 和有效的 LINE user ID。",
      lineNotificationsCompleteLabel: "任务完成",
      lineNotificationsCompleteDesc: "消息包含任务名称、Agent、项目和简短 session ID。",
      lineNotificationsAttentionLabel: "需要你处理",
      lineNotificationsAttentionDesc: "只提醒你回到电脑处理，不发送审批详情。",
      lineNotificationsSaved: "LINE 通知设置已保存。",
      ...
      rowSessionHudMaxProjects: "最多显示的大项目",
      rowSessionHudMaxProjectsDesc: "默认 5。输入 0 显示全部；子 agent 不计入上限。",
      unitProjects: "个大项目",
      valueAll: "全部",
      rowSessionHudProjectFilter: "显示项目",
      rowSessionHudProjectFilterDesc: "显示全部大项目，或只显示所选项目及其子 agents。",
      sessionHudProjectAll: "全部项目",
      sessionHudSummaryEnabled: "HUD: {state}",
    ...
    "zh-TW": {
      ...
      sidebarDiscordBot: "Discord Bot",
      notificationRepliesTitle: "通知回應",
      notificationRepliesSubtitle: "修改角色暱稱，以及 Discord 與 LINE 共用的完成、失敗與等待回應。",
      sidebarLineNotifications: "LINE 通知",
      lineNotificationsTitle: "LINE 手機通知",
      lineNotificationsSubtitle: "任務完成或需要你處理時，傳送一則簡短 LINE 訊息；不提供手機遠端核准。",
      lineNotificationsSetupTitle: "LINE Messaging API",
      lineNotificationsTokenLabel: "Channel access token",
      lineNotificationsTokenDesc: "Token 會存放在獨立的使用者資料檔，不會寫入 Clawd 偏好設定。",
      lineNotificationsTokenConfiguredDesc: "已儲存 Token；再次儲存會直接取代。",
      lineNotificationsTokenPlaceholder: "貼上 Channel access token",
      lineNotificationsSaveToken: "儲存 Token",
      lineNotificationsTokenRequired: "請先貼上 Channel access token。",
      lineNotificationsTokenSaveFailed: "無法儲存 LINE Token。",
      lineNotificationsTokenSaved: "LINE Token 已儲存。",
      lineNotificationsUserIdLabel: "你的 LINE user ID",
      lineNotificationsUserIdDesc: "請填入 Messaging API 中以 U 開頭、共 33 字元的 user ID。",
      lineNotificationsUserIdPlaceholder: "U0123456789abcdef0123456789abcdef",
      lineNotificationsSaveUserId: "儲存 user ID",
      lineNotificationsTestLabel: "測試通知",
      lineNotificationsTestDesc: "傳送一則測試訊息；這會使用 LINE 方案的一則訊息額度。",
      lineNotificationsSendTest: "傳送測試",
      lineNotificationsTestFailed: "LINE 測試訊息傳送失敗。",
      lineNotificationsTestSent: "LINE 測試訊息已傳送。",
      lineNotificationsControlTitle: "通知控制",
      lineNotificationsEnableLabel: "傳送 LINE 通知",
      lineNotificationsEnableDesc: "總開關；關閉後會立即停止所有 LINE API 呼叫。",
      lineNotificationsEnableNeedsSetup: "請先儲存 Token 與有效的 LINE user ID。",
      lineNotificationsCompleteLabel: "任務完成",
      lineNotificationsCompleteDesc: "訊息會包含任務名稱、Agent、專案與簡短 session ID。",
      lineNotificationsAttentionLabel: "需要你處理",
      lineNotificationsAttentionDesc: "只提醒你回到電腦處理，不會傳送核准細節。",
      lineNotificationsSaved: "LINE 通知設定已儲存。",
      discordBotTitle: "Discord Bot 通知",
      discordBotSubtitle: "連接 Bot，並選擇接收任務通知的 Discord 頻道。",
      discordBotSetupTitle: "Discord Bot",
      discordBotTokenLabel: "Bot Token",
      discordBotTokenDesc: "Token 會存放在獨立的使用者資料檔，不會寫入 Clawd 偏好設定。",
      discordBotTokenConfiguredDesc: "已儲存 Token；再次儲存會直接取代。",
      discordBotTokenPlaceholder: "貼上 Bot Token",
      discordBotSaveToken: "儲存 Token",
      discordBotTokenRequired: "請先貼上 Discord Bot Token。",
      discordBotTokenSaveFailed: "無法儲存 Discord Bot Token。",
      discordBotTokenSaved: "Discord Bot Token 已儲存。",
      discordBotChannelIdLabel: "通知頻道 ID",
      discordBotChannelIdDesc: "Bot 只會把任務完成訊息傳送到這個頻道。",
      discordBotChannelIdPlaceholder: "例如 123456789012345678",
      discordBotSaveChannelId: "儲存頻道 ID",
      discordBotTestLabel: "測試通知",
      discordBotTestDesc: "傳送一則安全測試訊息到已設定的頻道。",
      discordBotSendTest: "傳送測試",
      discordBotTestFailed: "Discord 測試訊息傳送失敗。",
      discordBotTestSent: "Discord 測試訊息已傳送。",
      discordBotControlTitle: "通知控制",
      discordBotEnableLabel: "傳送 Discord 通知",
      discordBotEnableDesc: "總開關；關閉後會立即停止所有 Discord API 呼叫。",
      discordBotEnableNeedsSetup: "請先儲存 Token 與有效的頻道 ID。",
      discordBotCompleteLabel: "任務完成",
      discordBotCompleteDesc: "共用 LINE 的隨機完成回覆，並避免連續出現同一句。",
      discordBotSaved: "Discord Bot 通知設定已儲存。",
      discordBotRepliesTitle: "通知回應",
      discordBotNicknameLabel: "角色暱稱",
      discordBotNicknameDesc: "角色在通知中使用的名字。",
      discordBotNicknamePlaceholder: "例如：奶茶",
      discordBotCompleteRepliesLabel: "任務完成回應",
      discordBotCompleteRepliesDesc: "每次任務完成時會隨機選擇一則回應。",
      discordBotReplyLabel: "回應",
      discordBotDeleteReply: "刪除",
      discordBotAddReply: "＋新增回應",
      discordBotInterruptedReplyLabel: "任務失敗或中斷",
      discordBotInterruptedReplyDesc: "任務未完成便停止時傳送。",
      discordBotPermissionReplyLabel: "需要權限",
      discordBotPermissionReplyDesc: "需要你回到電腦確認權限時傳送。",
      discordBotChoiceReplyLabel: "等待你的選擇",
      discordBotChoiceReplyDesc: "任務需要你選擇選項時傳送。",
      discordBotInsertValue: "插入內容：",
      discordBotVariableOwner: "通知主人",
      discordBotVariableTask: "任務名稱",
      discordBotVariableProject: "專案名稱",
      discordBotVariableAgent: "Agent 名稱",
      discordBotVariableSession: "識別碼",
      discordBotPreviewLabel: "預覽",
      discordBotPreviewTask: "範例任務",
      discordBotPreviewResult: "範例結果",
      discordBotPreviewProject: "範例專案",
      discordBotSaveReplies: "儲存回應",
      discordBotResetReplies: "恢復預設",
      discordBotResetRepliesConfirm: "確定要把暱稱與所有回應恢復為預設內容嗎？",
      discordBotRepliesLoading: "正在載入回應……",
      discordBotRepliesLoadFailed: "無法載入回應，請重新開啟設定後再試。",
      discordBotRepliesSaveFailed: "無法儲存回應。",
      discordBotRepliesSaved: "回應已儲存。",
      discordBotRepliesReset: "已恢復預設回應。",
      discordBotAtLeastOneReply: "至少保留一則任務完成回應。",
      discordBotEmptyReply: "請填寫所有回應後再儲存。",
      ...
      rowSessionHudMaxProjects: "最多顯示的大專案",
      rowSessionHudMaxProjectsDesc: "預設 5。輸入 0 顯示全部；子 agent 不計入上限。",
      unitProjects: "個大專案",
      valueAll: "全部",
      rowSessionHudProjectFilter: "顯示專案",
      rowSessionHudProjectFilterDesc: "顯示全部大專案，或只顯示所選專案與它的子 agents。",
      sessionHudProjectAll: "全部專案",
      sessionHudSummaryEnabled: "HUD: {state}",
    ...
    ko: {
      ...
      sidebarLineNotifications: "LINE 알림",
      sidebarDiscordBot: "Discord Bot",
      notificationRepliesTitle: "알림 응답",
      notificationRepliesSubtitle: "Discord와 LINE에서 함께 사용하는 캐릭터 별명과 메시지를 수정합니다.",
      discordBotTitle: "Discord Bot Notifications",
      discordBotSubtitle: "Bot을 연결하고 작업 알림을 받을 Discord 채널을 선택합니다.",
      discordBotSetupTitle: "Discord Bot",
      discordBotTokenLabel: "Bot token",
      discordBotTokenDesc: "Stored in a separate user-data file and never written to Clawd preferences.",
      discordBotTokenConfiguredDesc: "A token is already stored. Saving replaces it.",
      ...
      discordBotCompleteDesc: "Uses the same randomized completion replies as LINE and avoids immediate repeats.",
      discordBotSaved: "Discord bot notification settings saved.",
      discordBotRepliesTitle: "메시지 응답",
      discordBotNicknameLabel: "캐릭터 별명",
      discordBotNicknameDesc: "알림에서 캐릭터가 사용하는 이름입니다.",
      discordBotNicknamePlaceholder: "예: 밀크티",
      discordBotCompleteRepliesLabel: "작업 완료 응답",
      discordBotCompleteRepliesDesc: "작업이 완료될 때마다 응답 하나를 무작위로 선택합니다.",
      discordBotReplyLabel: "응답",
      discordBotDeleteReply: "삭제",
      discordBotAddReply: "+ 응답 추가",
      discordBotInterruptedReplyLabel: "작업 실패 또는 중단",
      discordBotInterruptedReplyDesc: "작업이 완료되기 전에 중지되면 전송합니다.",
      discordBotPermissionReplyLabel: "권한 필요",
      discordBotPermissionReplyDesc: "컴퓨터로 돌아와 권한을 확인해야 할 때 전송합니다.",
      discordBotChoiceReplyLabel: "선택 대기 중",
      discordBotChoiceReplyDesc: "작업에 사용자의 선택이 필요할 때 전송합니다.",
      discordBotInsertValue: "삽입:",
      discordBotVariableOwner: "소유자 멘션",
      discordBotVariableTask: "작업 이름",
      discordBotVariableProject: "프로젝트 이름",
      discordBotVariableAgent: "Agent 이름",
      discordBotVariableSession: "세션 ID",
      discordBotPreviewLabel: "미리보기",
      discordBotPreviewTask: "예시 작업",
      discordBotPreviewResult: "예시 결과",
      discordBotPreviewProject: "예시 프로젝트",
      discordBotSaveReplies: "응답 저장",
      discordBotResetReplies: "기본값 복원",
      discordBotResetRepliesConfirm: "별명과 모든 응답을 기본값으로 복원할까요?",
      discordBotRepliesLoading: "응답을 불러오는 중...",
      discordBotRepliesLoadFailed: "응답을 불러오지 못했습니다. 설정을 다시 열어 주세요.",
      discordBotRepliesSaveFailed: "응답을 저장하지 못했습니다.",
      discordBotRepliesSaved: "응답을 저장했습니다.",
      discordBotRepliesReset: "기본 응답을 복원했습니다.",
      discordBotAtLeastOneReply: "작업 완료 응답을 하나 이상 남겨 주세요.",
      discordBotEmptyReply: "저장하기 전에 모든 응답을 입력하세요.",
      lineNotificationsTitle: "LINE 모바일 알림",
      lineNotificationsSubtitle: "작업이 완료되거나 확인이 필요할 때 짧은 LINE 메시지를 보냅니다. 모바일 원격 승인은 포함하지 않습니다.",
      lineNotificationsSetupTitle: "LINE Messaging API",
      lineNotificationsTokenLabel: "Channel access token",
      lineNotificationsTokenDesc: "Token은 별도 사용자 데이터 파일에 저장되며 Clawd 환경설정에 기록되지 않습니다.",
      lineNotificationsTokenConfiguredDesc: "Token이 저장되어 있습니다. 다시 저장하면 교체됩니다.",
      lineNotificationsTokenPlaceholder: "Channel access token 붙여넣기",
      lineNotificationsSaveToken: "Token 저장",
      lineNotificationsTokenRequired: "Channel access token을 먼저 입력하세요.",
      lineNotificationsTokenSaveFailed: "LINE Token을 저장하지 못했습니다.",
      lineNotificationsTokenSaved: "LINE Token을 저장했습니다.",
      lineNotificationsUserIdLabel: "LINE user ID",
      lineNotificationsUserIdDesc: "U로 시작하는 33자 Messaging API user ID를 입력하세요.",
      lineNotificationsUserIdPlaceholder: "U0123456789abcdef0123456789abcdef",
      lineNotificationsSaveUserId: "user ID 저장",
      lineNotificationsTestLabel: "알림 테스트",
      lineNotificationsTestDesc: "테스트 메시지 한 건을 보냅니다. LINE 요금제 메시지 한 건을 사용합니다.",
      lineNotificationsSendTest: "테스트 보내기",
      lineNotificationsTestFailed: "LINE 테스트 메시지를 보내지 못했습니다.",
      lineNotificationsTestSent: "LINE 테스트 메시지를 보냈습니다.",
      lineNotificationsControlTitle: "알림 제어",
      lineNotificationsEnableLabel: "LINE 알림 보내기",
      lineNotificationsEnableDesc: "마스터 스위치입니다. 끄면 모든 LINE API 호출이 즉시 중단됩니다.",
      lineNotificationsEnableNeedsSetup: "Token과 유효한 LINE user ID를 먼저 저장하세요.",
      lineNotificationsCompleteLabel: "작업 완료",
      lineNotificationsCompleteDesc: "작업명, Agent, 프로젝트, 짧은 session ID를 포함합니다.",
      lineNotificationsAttentionLabel: "확인 필요",
      lineNotificationsAttentionDesc: "컴퓨터로 돌아오라는 알림만 보내며 승인 세부정보는 보내지 않습니다.",
      lineNotificationsSaved: "LINE 알림 설정을 저장했습니다.",
      ...
      rowSessionHudMaxProjects: "표시할 최대 프로젝트 수",
      rowSessionHudMaxProjectsDesc: "기본값은 5입니다. 0을 입력하면 모두 표시하며, 하위 agent는 제한에 포함되지 않습니다.",
      unitProjects: "개 프로젝트",
      valueAll: "전체",
      rowSessionHudProjectFilter: "표시 프로젝트",
      rowSessionHudProjectFilterDesc: "모든 프로젝트 또는 선택한 프로젝트와 하위 agent만 표시합니다.",
      sessionHudProjectAll: "모든 프로젝트",
      sessionHudSummaryEnabled: "HUD: {state}",
    ...
    ja: {
      ...
      sidebarLineNotifications: "LINE 通知",
      sidebarDiscordBot: "Discord Bot",
      notificationRepliesTitle: "通知メッセージ",
      notificationRepliesSubtitle: "Discord と LINE で共有するキャラクター名とメッセージを編集します。",
      discordBotTitle: "Discord Bot Notifications",
      discordBotSubtitle: "Bot を接続し、タスク通知を受け取る Discord チャンネルを選択します。",
      discordBotSetupTitle: "Discord Bot",
      discordBotTokenLabel: "Bot token",
      discordBotTokenDesc: "Stored in a separate user-data file and never written to Clawd preferences.",
      discordBotTokenConfiguredDesc: "A token is already stored. Saving replaces it.",
      ...
      discordBotCompleteDesc: "Uses the same randomized completion replies as LINE and avoids immediate repeats.",
      discordBotSaved: "Discord bot notification settings saved.",
      discordBotRepliesTitle: "通知メッセージ",
      discordBotNicknameLabel: "キャラクターの呼び名",
      discordBotNicknameDesc: "通知でキャラクターが使用する名前です。",
      discordBotNicknamePlaceholder: "例：ミルクティー",
      discordBotCompleteRepliesLabel: "タスク完了メッセージ",
      discordBotCompleteRepliesDesc: "タスク完了時にメッセージをランダムで1つ選びます。",
      discordBotReplyLabel: "メッセージ",
      discordBotDeleteReply: "削除",
      discordBotAddReply: "+ メッセージを追加",
      discordBotInterruptedReplyLabel: "タスクの失敗・中断",
      discordBotInterruptedReplyDesc: "タスクが完了前に停止したときに送信します。",
      discordBotPermissionReplyLabel: "権限が必要",
      discordBotPermissionReplyDesc: "PCに戻って権限を確認する必要があるときに送信します。",
      discordBotChoiceReplyLabel: "選択待ち",
      discordBotChoiceReplyDesc: "タスクが選択を必要としているときに送信します。",
      discordBotInsertValue: "挿入:",
      discordBotVariableOwner: "所有者をメンション",
      discordBotVariableTask: "タスク名",
      discordBotVariableProject: "プロジェクト名",
      discordBotVariableAgent: "Agent名",
      discordBotVariableSession: "セッションID",
      discordBotPreviewLabel: "プレビュー",
      discordBotPreviewTask: "サンプルタスク",
      discordBotPreviewResult: "サンプル結果",
      discordBotPreviewProject: "サンプルプロジェクト",
      discordBotSaveReplies: "メッセージを保存",
      discordBotResetReplies: "初期設定に戻す",
      discordBotResetRepliesConfirm: "呼び名とすべてのメッセージを初期設定に戻しますか？",
      discordBotRepliesLoading: "メッセージを読み込み中...",
      discordBotRepliesLoadFailed: "メッセージを読み込めませんでした。設定を開き直してください。",
      discordBotRepliesSaveFailed: "メッセージを保存できませんでした。",
      discordBotRepliesSaved: "メッセージを保存しました。",
      discordBotRepliesReset: "初期メッセージに戻しました。",
      discordBotAtLeastOneReply: "タスク完了メッセージを1つ以上残してください。",
      discordBotEmptyReply: "保存する前にすべてのメッセージを入力してください。",
      lineNotificationsTitle: "LINE モバイル通知",
      lineNotificationsSubtitle: "タスク完了時または確認が必要な時に短い LINE メッセージを送信します。モバイル承認は含みません。",
      lineNotificationsSetupTitle: "LINE Messaging API",
      lineNotificationsTokenLabel: "Channel access token",
      lineNotificationsTokenDesc: "Token は別のユーザーデータファイルに保存され、Clawd の設定には書き込まれません。",
      lineNotificationsTokenConfiguredDesc: "Token は保存済みです。再保存すると置き換えます。",
      lineNotificationsTokenPlaceholder: "Channel access token を貼り付け",
      lineNotificationsSaveToken: "Token を保存",
      lineNotificationsTokenRequired: "Channel access token を入力してください。",
      lineNotificationsTokenSaveFailed: "LINE Token を保存できませんでした。",
      lineNotificationsTokenSaved: "LINE Token を保存しました。",
      lineNotificationsUserIdLabel: "LINE user ID",
      lineNotificationsUserIdDesc: "U で始まる 33 文字の Messaging API user ID を入力してください。",
      lineNotificationsUserIdPlaceholder: "U0123456789abcdef0123456789abcdef",
      lineNotificationsSaveUserId: "user ID を保存",
      lineNotificationsTestLabel: "通知テスト",
      lineNotificationsTestDesc: "テストメッセージを 1 件送信します。LINE プランのメッセージを 1 件使用します。",
      lineNotificationsSendTest: "テスト送信",
      lineNotificationsTestFailed: "LINE テストメッセージを送信できませんでした。",
      lineNotificationsTestSent: "LINE テストメッセージを送信しました。",
      lineNotificationsControlTitle: "通知コントロール",
      lineNotificationsEnableLabel: "LINE 通知を送信",
      lineNotificationsEnableDesc: "マスタースイッチです。オフにするとすべての LINE API 呼び出しを直ちに停止します。",
      lineNotificationsEnableNeedsSetup: "Token と有効な LINE user ID を先に保存してください。",
      lineNotificationsCompleteLabel: "タスク完了",
      lineNotificationsCompleteDesc: "タスク名、Agent、プロジェクト、短い session ID を含めます。",
      lineNotificationsAttentionLabel: "確認が必要",
      lineNotificationsAttentionDesc: "PC に戻るよう通知するだけで、承認の詳細は送信しません。",
      lineNotificationsSaved: "LINE 通知設定を保存しました。",
      ...
      rowSessionHudMaxProjects: "表示するプロジェクトの上限",
      rowSessionHudMaxProjectsDesc: "既定値は 5 です。0 を入力するとすべて表示し、子 agent は上限に含めません。",
      unitProjects: "プロジェクト",
      valueAll: "すべて",
      rowSessionHudProjectFilter: "表示するプロジェクト",
      rowSessionHudProjectFilterDesc: "すべてのプロジェクト、または選択したプロジェクトと子 agent のみを表示します。",
      sessionHudProjectAll: "すべてのプロジェクト",
      sessionHudSummaryEnabled: "HUD: {state}",
