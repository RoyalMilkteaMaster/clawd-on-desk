...
const RELEASES_LATEST_URL = "https://github.com/RoyalMilkteaMaster/clawd-on-desk/releases/latest";
...
function initUpdater(ctx, deps = {}) {
  ...
  function fetchLatestReleaseViaRedirect() {
    return new Promise((resolve, reject) => {
      const req = httpsGet({
        hostname: "github.com",
        path: "/RoyalMilkteaMaster/clawd-on-desk/releases/latest",
        headers: {
  ...
  function fetchLatestReleaseFromApi() {
    return new Promise((resolve, reject) => {
      ...
      const req = httpsGet({
        ...
        path: "/repos/RoyalMilkteaMaster/clawd-on-desk/releases/latest",
        headers,
      }, (res) => {
